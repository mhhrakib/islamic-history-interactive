...
import { ChevronLeftIcon, ChevronRightIcon, PlusIcon, PencilSquareIcon } from '../icons';
...
export const EraRow: React.FC<EraRowProps> = ({ era, profile, onSelectTopic, onAddTopic, onEditTopic, onDeleteTopic, onReorderTopics, onEditEra }) => {
              ...
              <div className="flex-grow">
               ...
               {isAdmin && (
                  <div className="flex flex-col md:flex-row gap-2 flex-shrink-0">
                      <button onClick={() => onEditEra(era)} className="p-2 bg-blue-100 text-blue-700 rounded-full hover:bg-blue-200 dark:bg-blue-900/50 dark:text-blue-300 dark:hover:bg-blue-900/80" aria-label="Edit Era">
                          <PencilSquareIcon className="w-5 h-5"/>
                      </button>
                      <button onClick={() => onAddTopic(era.id)} className="flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-lg font-semibold hover:bg-primary/20 dark:bg-green-300/10 dark:text-green-300 dark:hover:bg-green-300/20 transition-colors">
