...
import type { HistoricalTopic, HistoricalEra, AppEvent } from '../types';
  ...
  return (
    <div className="min-h-screen bg-base dark:bg-gray-900 text-text-primary dark:text-gray-200 font-sans">
      ...
      <main className="container mx-auto p-4 md:p-8">
        ...
        {showSearchResults ? (
            <SearchResults results={searchResults} query={searchQuery} onSelectTopic={onSelectTopic} />
        ) : (
            <div className="space-y-16">
                ...
                {user && user.provider !== 'guest' && profile && (
                  <Dashboard eras={eras} profile={profile} onSelectTopic={onSelectTopic} allEventsCount={allEventsCount} />
                )}
