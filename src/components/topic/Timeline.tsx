...
export const Timeline: React.FC<TimelineProps> = ({
  ...
  return (
    <div className="bg-surface dark:bg-gray-800 rounded-xl shadow-md p-4 flex-shrink-0">
      <h3 className="font-serif text-lg text-primary dark:text-green-300 mb-3 px-2">
        {t("timeline.title")}
      </h3>
          ...
          {events.map((event, index) => {
            ...
            return (
              <div
                ...
                className={`relative flex-shrink-0 w-48 group transition-transform ${
                  isAdmin ? "dnd-item" : ""
                }`}
              >
                <button
                ...
                {isAdmin && (
                  ...
                  >
                    <button
                      ...
                      className="p-1.5 bg-white/80 dark:bg-gray-900/80 rounded-full text-blue-600 hover:bg-white dark:hover:bg-gray-900"
                    >
                      <EditIcon className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => onDeleteEvent(event.id)}
                      className="p-1.5 bg-white/80 dark:bg-gray-900/80 rounded-full text-red-600 hover:bg-white dark:hover:bg-gray-900"
                    >
