...
import { StreakIcon, ProgressIcon, TrophyIcon } from "../common/icons";
...
const StatItem: React.FC<{
  ...
  <div
    className="flex items-center gap-1.5 text-primary dark:text-gray-300"
    title={tooltip}
  >
    {icon}
...
export const UserStats: React.FC = () => {
  ...
  return (
    <div className="hidden md:flex items-center gap-4 border-r border-border-color dark:border-gray-700 pr-4">
      <StatItem
        icon={
          <ProgressIcon className="w-5 h-5 text-green-600 dark:text-green-400" />
        }
      ...
      <StatItem
        icon={
          <StreakIcon className="w-5 h-5 text-orange-500 dark:text-orange-400" />
        }
