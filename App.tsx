...
import { GlobalQuizPage } from './components/GlobalQuizPage';
...
const AppContent: React.FC = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case 'topic':
        return selectedTopic ? <TopicDetailPage topic={selectedTopic} onBack={handleGoBack} onLoginClick={() => setIsAuthModalOpen(true)} initialEventId={initialEventId || undefined} onNavigate={navigateTo} /> : <HomePage onSelectTopic={handleSelectTopic} onNavigate={navigateTo} onLoginClick={() => setIsAuthModalOpen(true)} />;
      case 'profile':
      ...
      case 'home':
      default:
        return <HomePage onSelectTopic={handleSelectTopic} onNavigate={navigateTo} onLoginClick={() => setIsAuthModalOpen(true)} />;
    }
  };
